...
unique_pars = unique_pars[counts_sorted[:5000]]
...
sims_final.save('simulations/simulations_arrestin_scipy_181.h5')
...
sims_final_noarrestin.save('simulations/simulations_noarrestin_scipy_181.h5')